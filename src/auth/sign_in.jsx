...
const Sign_in = () => {
 const [showNotification, setShowNotification] = useState(true);
  ...
  return (
    <div>
      <div id='main' className='w-screen   mx-auto   bg-gradient-to-r from-blue-600 to-blue-800 flex min-h-screen '>
        
        <div id='left' className='w-full lg:w-1/2 bg-neutral-900 text-white  flex flex-col lg:items-end justify-center  lg:rounded-l-xs rounded-4xl sm:mx-18 mx-8 my-15  lg:m-0 '> 
          ...
          <div className="bg-neutral-800 text-sm p-4 rounded-md flex justify-between  items-center mb-6 mt-3 ml-10 mr-8">
           ...
           <div > 
                          ...
                          <div className="flex justify-between ">
                            ...
                            <input type="checkbox"  placeholder="none" className=" accent-blue-500" label="remember"/><p className=" text-sm text-gray-400 ml-2 shrink-0"> Remember Me</p></label></div>
                           <p className='text-gray-400 pt-2 shrink-0 ml-1 text-sm'>Forgot Password?</p>
