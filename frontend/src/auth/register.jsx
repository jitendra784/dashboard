  ...
  return (
    <div>
      <div id='main' className='w-full  mx-auto   bg-gradient-to-r from-blue-600 to-blue-800 flex min-h-screen'>
        ...
        <div id='left' className='w-full lg:w-1/2 bg-neutral-900 text-white  flex flex-col lg:items-end justify-center     lg:rounded-md rounded-4xl mx-30 my-15 lg:m-0 '> 
        <div className='container px-2 bg-neutral-900  lg:pl-33 w-full mx-10 py-32 rounded-4xl'>
          ...
          <button className="w-full bg-neutral-800 py-2 rounded-full font-semibold hover:opacity-90 mt-5">
            Sign Up
          </button>
