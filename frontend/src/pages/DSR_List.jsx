...
export default function DSRList() {
  ...
  useEffect(() => {
    axios.get("http://localhost:8001/api/dsr")
      .then(res => setDsrs(res.data));
  }, []);

  return (
    <div className="overflow-x-auto mt-6">
      <table className="table-auto w-full border rounded-md text-white">
        ...
        <tbody>
          {dsrs.map((item, index) => (
            <tr key={item._id} className="border-t bg-gray-800">
